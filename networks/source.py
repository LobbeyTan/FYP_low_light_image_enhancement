...
class Unet_resize_conv_with_attention(nn.Module):
    def __init__(self):
        ...
        self.attention_4 = Attention(256, 512, 512, 256)
        self.attention_3 = Attention(128, 256, 256, 128)
        self.attention_2 = Attention(64, 128, 128, 64)
        self.attention_1 = Attention(32, 64, 64, 32)
        self.attention_0 = Attention(3, 4, 4, 3)
