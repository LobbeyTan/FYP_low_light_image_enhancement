...
class Unet_resize_conv_with_attention(nn.Module):
    def __init__(self):
        ...
        # Original 256 for all
        self.attention_4 = Attention(256, 512, 256, 256)
        self.attention_3 = Attention(128, 256, 256, 128)
        self.attention_2 = Attention(64, 128, 256, 64)
        self.attention_1 = Attention(32, 64, 256, 32)
        self.attention_0 = Attention(3, 4, 256, 3)
